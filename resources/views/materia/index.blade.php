...
<div class="container-fluid">
    <div class="row-6"> <!-- ampliar -->
        <div class="card card-info"> <!-- card card-primary card-outline -->
            ...
            <h5 class="m-0"><i class="fas fa-users"></i>  Mostrar Materias Registradas</h5>
            </div>
            <div class="card-body">
                    <a href="materia/create" class="btn btn-primary mb-3"><i class="fa regular fa-plus"></i> Agregar Materia</a>
                    <table id="materia" class="table table-bordered table-condensed table hover table-striped mt-2 responsive">
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{route ('materia.destroy',$materia->id)}}" method="POST">
                                         <a href="/materia/{{$materia->id}}/edit" class="btn btn-info btn-xs"><i class="fa thing fa-pen"></i> Editar</a>
                                         @csrf
                                         @method('DELETE')
