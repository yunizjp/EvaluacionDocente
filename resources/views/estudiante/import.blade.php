    ...
    <div class="row-6"> <!-- ampliar -->
        <div class="card card-info"> <!-- card card-primary card-outline -->
            <div class="card-header">                
                 <h5 class="m-0"><i class="fas fa-file-import"></i>  Importar informacion a la base de estudiantes</h5>
            </div>
            <div class="card-body">
                <div class="col-md-6">
                     <form action="{{route('/estudiante/importdata')}}" method="POST" enctype="multipart/form-data">
                            @csrf
